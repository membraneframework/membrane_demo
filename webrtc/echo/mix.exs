...
#      {:membrane_funnel_plugin, github: "membraneframework/membrane_funnel_plugin", branch: :release},
      {:membrane_funnel_plugin, path: "/home/michal/Repos/membrane/membrane_funnel_plugin"},
